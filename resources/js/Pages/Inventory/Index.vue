                    ...
                    <tr :class="{ 'bg-yellow-lighten-5': isLowStock(item) }">
                        ...
                        <td>
                            <div class="d-flex align-center gap-2">
                                <v-text-field v-model.number="restockQuantities[item.id]" type="number" min="1"
                                    variant="outlined" density="compact" hide-details style="width: 80px;" />
                                <v-btn size="small" color="primary" @click="handleRestock(item.id)"
                                    :loading="restockLoading[item.id]">
                                    Restock
                                </v-btn>
                            </div>
                        </td>
